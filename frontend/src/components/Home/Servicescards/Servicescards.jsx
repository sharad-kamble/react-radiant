    ...
    return (
        ...
        <div className='container-fluid homepagecard'>
            <div className=" text-center pt-5">
                <h2 className="ourserv"><strong>OUR SERVICES</strong></h2>
            ...
            <div className="row justify-content-center mt-4" >
                ...
                <div className="card m-4 mb-4 cardImg" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Radiant IT Services gives you top online visibility. Our online marketing techniques are very useful in generating ROI for businesses.</p>
                ...
                <div className="card m-4 mb-4 cardImg" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">In today’s technical era, a website is needed for every business. The radiant IT Services design and develop a website for brand visibility</p>
            ...
            <div className="row justify-content-center mt-4" >
                <div className="card m-4 mb-4 cardImg" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Radiant IT Services is the best software development company in the industry, which gives more reliable Applications.</p>
                ...
                <div className="card m-4 cardImg" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Radiant IT services Pvt. Ltd. has
