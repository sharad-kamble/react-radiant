                ...
                <div className="boyimg" style={{ background: `url(${bgmission})` }}>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className='mt-4'>
                                In Radiant, we believe in the transformative power of education.<br /> Our mission is to empower individuals to acquire new skills,<br />and empower their knowledge.
                            </p>
